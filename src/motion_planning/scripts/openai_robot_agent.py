...
class OpenAIRobotAgent:
    def __init__(self):
        ...
        api_key = "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"
        if not api_key:
